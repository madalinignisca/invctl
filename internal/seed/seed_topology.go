...
func (b *builder) netGroups() {
	...
	for _, spec := range specs {
		...
		if err := b.store.CreateNetGroup(b.ctx, Permit, g); err != nil {
...
func (b *builder) netGroupMembers() {
	...
	for _, m := range members {
		...
		if err := b.store.AddNetGroupMember(b.ctx, Permit, member); err != nil {
...
func (b *builder) netUplinks() {
	...
	for _, u := range uplinks {
		...
		if err := b.store.CreateNetUplink(b.ctx, Permit, link); err != nil {
...
func (b *builder) netAttachments() {
	...
	for _, spec := range specs {
		...
		if err := b.store.CreateNetAttachment(b.ctx, Permit, att, members); err != nil {
...
func (b *builder) netAnchors() {
	...
	for _, a := range anchors {
		...
		if err := b.store.CreateNetAnchor(b.ctx, Permit, anchor); err != nil {
