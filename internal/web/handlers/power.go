...
func (a *App) PowerPanelCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreatePowerPanel(r.Context(), actor(r), p)
	}
	if err != nil {
...
func (a *App) PowerPanelRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetirePowerPanel(r.Context(), actor(r), r.PathValue("id")); err != nil {
...
func (a *App) PowerFeedCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreatePowerFeed(r.Context(), actor(r), f)
	}
	if err != nil {
		if errs, ok := validationErrors(err); ok {
...
func (a *App) PowerFeedRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetirePowerFeed(r.Context(), actor(r), r.PathValue("id")); err != nil {
...
func (a *App) PowerInputCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreatePowerInput(r.Context(), actor(r), i)
	}
	if err != nil {
...
func (a *App) PowerInputRetire(w http.ResponseWriter, r *http.Request) {
	assetID := r.PathValue("id")
	if err := a.Store.RetirePowerInput(r.Context(), actor(r), r.PathValue("inputID")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
