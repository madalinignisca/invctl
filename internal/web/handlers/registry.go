...
func (a *App) AggregateCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		...
		err = a.Store.CreateAggregate(r.Context(), actor(r), agg)
	}
	if err != nil {
...
func (a *App) AggregateRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetireAggregate(r.Context(), actor(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
...
func (a *App) ASNCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		...
		err = a.Store.CreateASN(r.Context(), actor(r), asn)
	}
	if err != nil {
		messages, ok := validationErrors(err)
		if !ok {
...
func (a *App) ASNRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetireASN(r.Context(), actor(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
