...
func (a *App) JournalCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreateJournalEntry(r.Context(), actor(r), entry)
	}
	if err != nil {
...
func (a *App) JournalUpdate(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.UpdateJournalEntry(r.Context(), actor(r), &updated); err != nil {
...
func (a *App) JournalRetire(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.RetireJournalEntry(r.Context(), actor(r), existing.ID); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
