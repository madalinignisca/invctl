...
func (a *App) UserCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.CreateUser(r.Context(), actor(r), u); err != nil {
		if isConflict(err) {
			a.renderUserList(w, r, http.StatusUnprocessableEntity,
...
func (a *App) UserSetCosts(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.SetUserCostVisibility(r.Context(), actor(r), id, checkbox(r, "can_see_costs"))
...
func (a *App) UserSetActive(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.SetUserActive(r.Context(), actor(r), id, checkbox(r, "active"))
...
func (a *App) UserScrub(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.ScrubUser(r.Context(), actor(r), id)
