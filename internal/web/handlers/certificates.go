...
func (a *App) CertificateCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreateCertificate(r.Context(), a.permit(r), c)
	}
	if err != nil {
...
func (a *App) CertificateRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetireCertificate(r.Context(), a.permit(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
...
func (a *App) CertificateDeployAsset(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.DeployCertificateToAsset(r.Context(), a.permit(r), id,
...
func (a *App) CertificateDeployService(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.DeployCertificateToService(r.Context(), a.permit(r), id,
...
func (a *App) CertificateUndeployAsset(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.UndeployCertificateFromAsset(r.Context(), a.permit(r), id, r.PathValue("assetID"))
	a.afterCertificateWrite(w, r, err, id)
}
...
func (a *App) CertificateUndeployService(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	err := a.Store.UndeployCertificateFromService(r.Context(), a.permit(r), id, r.PathValue("serviceID"))
	a.afterCertificateWrite(w, r, err, id)
}
