...
func (a *App) TagCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreateTag(r.Context(), a.permit(r), t)
	}
	if err != nil {
...
func (a *App) TagUpdate(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.UpdateTag(r.Context(), a.permit(r), &updated); err != nil {
...
func (a *App) TagRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetireTag(r.Context(), a.permit(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
...
func (a *App) TagRestore(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RestoreTag(r.Context(), a.permit(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
