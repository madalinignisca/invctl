...
func (a *App) CustomFieldCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err == nil {
		err = a.Store.CreateCustomField(r.Context(), a.permit(r), f)
	}
	if err != nil {
...
func (a *App) CustomFieldUpdate(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.UpdateCustomField(r.Context(), a.permit(r), &updated); err != nil {
...
func (a *App) CustomFieldRetire(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RetireCustomField(r.Context(), a.permit(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
...
func (a *App) CustomFieldRestore(w http.ResponseWriter, r *http.Request) {
	if err := a.Store.RestoreCustomField(r.Context(), a.permit(r), r.PathValue("id")); err != nil {
		a.handleStoreError(w, r, err)
		return
	}
...
func (a *App) CustomFieldOptions(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.Store.SetCustomFieldOptions(r.Context(), a.permit(r), id, expected, opts); err != nil {
